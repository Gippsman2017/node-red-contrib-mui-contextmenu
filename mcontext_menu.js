 ...
 * Additions for mui connectivity Gippsman2017
...
module.exports = function(RED) {
    ...
    function ContextMenuNode(config) {
        ...
        var done = ui.addWidget({
            ...
            initController: function($scope, events) {
                ...
                console.log("mui_context_menu: mui_contextmenu.initController()")
                ...
                $scope.init = function (config) {
                    console.log("mui_context_menu: mui_contextmenu.initController > $scope.init()")
                    $scope.config = config;
                    ...
                    if (!$scope.contextMenu) {
                        ...
                        try {
                            ...
                            if(window.ContextMenu){
                                ...
                                var urls = [
                                    'mui_context_menu/contextmenu.js',
                                    'mui_context_menu/contextmenu.css'
                                ];
                ...
                $scope.$watch('msg', function(msg) {
                    ...
                    if (!$scope.config) {
                        console.log("mui_context_menu: $scope.config is empty :(")
                        return;
                    }
                    ...
                    console.log("mui_context_menu: msg received")
    ...
    RED.nodes.registerType("mui_context_menu", ContextMenuNode);
    ...
    //     ui: { path: "mypath" },
    var uiPath = ((RED.settings.mui || {}).path) || 'mui';
	
    // Create the complete server-side path
    uiPath = '/' + uiPath + '/mui_context_menu/*';
