# node-red-contrib-mui-contextmenu

Note: this node is a dulicate of node-red-contrib-ui-contextmenu and it will follow all the great work as below, it has been created only to add it to the mDashboard ui suite.

Therefore as per node-red-contrib-ui-contextmenu below.
